sub-item-manage = let
	...
	class PropertySubItem extends SubItem
		...
		_update-all-property-sub-item = !->
			console.log _property-sub-items
		...
		init-all-event: !->
			@top-dom.click !~> @top-self!; _update-all-property-sub-item!
			@remove-dom.click !~> @remove-self!; _update-all-property-sub-item!
		...
		get-value-from-input: ->
			console.log @name-input-dom.val!, @price-input-dom.val!
			return {
